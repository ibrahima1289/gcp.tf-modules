...
| [GCP VM](modules/compute/gcp_vm/README.md) | `modules/compute/gcp_vm` | Creates one or many Compute Engine VM instances with configurable machine types, boot disks, data disks, networking, service accounts, Spot scheduling, Shielded VM, and metadata across multiple zones. |
...
| [GCP AlloyDB](modules/database/gcp_alloyDB/README.md) | `modules/database/gcp_alloyDB` | Creates one or many AlloyDB for PostgreSQL clusters with primary instances, horizontally scalable read pool instances, PITR, automated backups, CMEK, and maintenance window controls. |
...
| [GCP VM](tf-plans/gcp_vm/README.md) | `tf-plans/gcp_vm` | [modules/compute/gcp_vm](modules/compute/gcp_vm/README.md) |
...
| [GCP AlloyDB](tf-plans/gcp_alloydb/README.md) | `tf-plans/gcp_alloydb` | [modules/database/gcp_alloyDB](modules/database/gcp_alloyDB/README.md) |
