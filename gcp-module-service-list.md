...
| **Terraform Modules in repo** | **27** — [VM](modules/compute/gcp_vm/README.md), [Organization](modules/governance/organization/README.md), [Folder](modules/governance/folder/README.md), [Project](modules/governance/project/README.md), [Subnetworks](modules/networking/gcp_subnetworks/README.md), [Networks (VPC)](modules/networking/gcp_networks/README.md), [Cloud NAT](modules/networking/gcp_cloud_nat/README.md), [Cloud Router](modules/networking/gcp_cloud_router/README.md), [Cloud VPN](modules/networking/gcp_cloud_vpn/README.md), [Autoscaling](modules/networking/gcp_autoscaling/README.md), [Cloud Load Balancer](modules/networking/gcp_cloud_load_balancer/README.md), [Cloud CDN](modules/networking/gcp_cloud_cdn/README.md), [Cloud DNS](modules/networking/gcp_cloud_dns/README.md), [GKE](modules/compute/gcp_gke/README.md), [Cloud Run](modules/compute/gcp_cloud_run/README.md), [App Engine](modules/compute/gcp_app_engine/README.md), [Pub/Sub](modules/app_development/Pub_Sub/README.md), [Labels](modules/governance/gcp_labels/README.md), [Cloud Billing](modules/governance/gcp_billing/README.md), [IAM](modules/security/gcp_iam/README.md), [Cloud Storage](modules/storage/gcp_cloud_storage/README.md), [Cloud Identity Groups](modules/security/gcp_group/README.md), [Cloud SQL](modules/database/gcp_cloud_sql/README.md), [AlloyDB](modules/database/gcp_alloyDB/README.md), [Cloud Spanner](modules/database/gcp_cloud_spanner/README.md), [Cloud Monitoring](modules/monitoring_devops/gcp_cloud_monitoring/README.md), [Cloud Logging](modules/monitoring_devops/gcp_cloud_logging/README.md) |
...
|---------|:---------:|--------------------|
| Compute Engine | ✅ | [`google_compute_instance`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_instance) — **[Explainer](modules/compute/gcp_vm/gcp-vm.md)** · **[Module](modules/compute/gcp_vm/README.md)** · **[Plan](tf-plans/gcp_vm/README.md)** |
| Autoscaling (MIG) | ✅ | [`google_compute_region_autoscaler`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_region_autoscaler) / [`google_compute_autoscaler`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_autoscaler) — **[Explainer](modules/networking/gcp_autoscaling/gcp_autoscaling.md)** · **[Module](modules/networking/gcp_autoscaling/README.md)** |
| Google Kubernetes Engine (GKE) | ✅ | [`google_container_cluster`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/container_cluster) — **[Module](modules/compute/gcp_gke/README.md)** · **[Plan](tf-plans/gcp_gke/README.md)** |
| Cloud Run | ✅ | [`google_cloud_run_v2_service`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/cloud_run_v2_service) — **[Explainer](modules/compute/gcp_cloud_run/gcp-cloud-run.md)** · **[Module](modules/compute/gcp_cloud_run/README.md)** · **[Plan](tf-plans/gcp_cloud_run/README.md)** |
| App Engine | ✅ | [`google_app_engine_application`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/app_engine_application) — **[Explainer](modules/compute/gcp_app_engine/gcp-app-engine.md)** · **[Module](modules/compute/gcp_app_engine/README.md)** · **[Plan](tf-plans/gcp_app_engine/README.md)** |
...
| AlloyDB for PostgreSQL | ✅ | [`google_alloydb_cluster`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/alloydb_cluster) · [`google_alloydb_instance`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/alloydb_instance) — **[Explainer](modules/database/gcp_alloyDB/gcp-alloydb.md)** · **[Module](modules/database/gcp_alloyDB/README.md)** · **[Plan](tf-plans/gcp_alloydb/README.md)** |
| Cloud Spanner | ✅ | [`google_spanner_instance`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/spanner_instance) · [`google_spanner_database`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/spanner_database) — **[Module](modules/database/gcp_cloud_spanner/README.md)** · **[Plan](tf-plans/gcp_cloud_spanner/README.md)** |
...
| Cloud Load Balancing | ✅ | [`google_compute_backend_service`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_backend_service) / [`google_compute_url_map`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_url_map) — **[Explainer](modules/networking/gcp_cloud_load_balancer/gcp-cloud-load-balancer.md)** · **[Module](modules/networking/gcp_cloud_load_balancer/README.md)** · **[Plan](tf-plans/gcp_cloud_load_balancer/README.md)** |
| Cloud CDN | ✅ | Via `enable_cdn` on [`google_compute_backend_bucket`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_backend_bucket) / [`google_compute_backend_service`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_backend_service) — **[Explainer](modules/networking/gcp_cloud_cdn/gcp-cloud-cdn.md)** · **[Module](modules/networking/gcp_cloud_cdn/README.md)** · **[Plan](tf-plans/gcp_cloud_cdn/README.md)** |
| Cloud DNS | ✅ | [`google_dns_managed_zone`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/dns_managed_zone) / [`google_dns_record_set`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/dns_record_set) — **[Module](modules/networking/gcp_cloud_dns/README.md)** · **[Plan](tf-plans/gcp_cloud_dns/README.md)** |
...
| Labels | ✅ | `labels` argument on most resources · [`google_org_policy_custom_constraint`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/org_policy_custom_constraint) — **[Explainer](modules/governance/gcp_labels/gcp-labels.md)** · **[Module](modules/governance/gcp_labels/README.md)** · **[Plan](tf-plans/gcp_labels/README.md)** |
...
- [GCP Labels Deployment Plan](tf-plans/gcp_labels/README.md)
